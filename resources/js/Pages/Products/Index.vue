    ...
    <MainLayout>
        ...
        >
            ...
            <form @submit.prevent="submitProduct" class="space-y-4">
                ...
                <button
                    ...
                    class="w-full bg-indigo-600 disabled:bg-slate-400 text-white py-3 rounded-xl text-sm font-bold shadow-md"
                >
                    {{ form.processing ? "در حال ثبت..." : "ذخیره محصول" }}
                </button>
            </form>
        </div>
        ...
        <div class="space-y-3 pb-10">
            ...
            >
                ...
                <div v-if="product.attributes.length > 0" class="space-y-1">
