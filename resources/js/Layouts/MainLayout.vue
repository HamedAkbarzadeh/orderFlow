...
const bottomNavItems = computed(() => {
    ...
    // اگر کاربر ادمین بود، دکمه پنل مدیریت اضافه شود
    if (isAdmin.value) {
        items.push({
            name: "مدیریت",
        ...
        >
            <div class="flex items-center justify-between px-6 py-4">
                ...
                <Link
                    ...
                    method="post"
                    as="button"
                    class="w-8 h-8 rounded-full bg-rose-50 text-rose-500 hover:bg-rose-100 hover:text-rose-600 flex items-center justify-center transition-colors shadow-sm"
                    title="خروج از سیستم"
                >
                    <svg
